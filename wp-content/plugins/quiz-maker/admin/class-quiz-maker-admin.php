...
class Quiz_Maker_Admin
{
    ...
    */
    ...
    // Black Friday
    public static function ays_quiz_black_friday_message($ishmar){
        if($ishmar == 0 ){
            $content = array();
            ...
            $content[] = '<div id="ays-quiz-dicount-black-friday-month-main" class="notice notice-success is-dismissible ays_quiz_dicount_info">';
                $content[] = '<div id="ays-quiz-dicount-black-friday-month" class="ays_quiz_dicount_month">';
                    $content[] = '<div class="ays-quiz-dicount-black-friday-box">';
                        $content[] = '<div class="ays-quiz-dicount-black-friday-wrap-box ays-quiz-dicount-black-friday-wrap-box-80" style="width: 70%;">';
                            $content[] = '<div class="ays-quiz-dicount-black-friday-title-row">' . __( 'Limited Time', AYS_QUIZ_NAME ) .' '. '<a href="https://ays-pro.com/great-bundle" class="ays-quiz-dicount-black-friday-button-sale" target="_blank">' . __( 'Sale', AYS_QUIZ_NAME ) . '</a>' . '</div>';
                            $content[] = '<div class="ays-quiz-dicount-black-friday-title-row">' . __( '(Quiz + Survey + Popup + Copy + Poll)!', AYS_QUIZ_NAME ) . '</div>';
                        $content[] = '</div>';

                        $content[] = '<div class="ays-quiz-dicount-black-friday-wrap-box ays-quiz-dicount-black-friday-wrap-text-box">';
                            $content[] = '<div class="ays-quiz-dicount-black-friday-text-row">' . __( '65% off', AYS_QUIZ_NAME ) . '</div>';
                        $content[] = '</div>';
                            ...
                            $content[] = '<div id="ays-quiz-countdown-main-container">';
                                $content[] = '<div class="ays-quiz-countdown-container">';
                                    $content[] = '<div id="ays-quiz-countdown" style="display: block;">';
                                        $content[] = '<ul>';
                                            $content[] = '<li><span id="ays-quiz-countdown-days">0</span>' . __( 'Days', AYS_QUIZ_NAME ) . '</li>';
                                            $content[] = '<li><span id="ays-quiz-countdown-hours">0</span>' . __( 'Hours', AYS_QUIZ_NAME ) . '</li>';
                                            $content[] = '<li><span id="ays-quiz-countdown-minutes">0</span>' . __( 'Minutes', AYS_QUIZ_NAME ) . '</li>';
                                            $content[] = '<li><span id="ays-quiz-countdown-seconds">0</span>' . __( 'Seconds', AYS_QUIZ_NAME ) . '</li>';
                                        $content[] = '</ul>';
                                    $content[] = '</div>';
                        ...
                        $content[] = '<div class="ays-quiz-dicount-black-friday-wrap-box" style="width: 25%;">';
                            $content[] = '<a href="https://ays-pro.com/great-bundle" class="ays-quiz-dicount-black-friday-button-buy-now" target="_blank">' . __( 'Get Your Deal', AYS_QUIZ_NAME ) . '</a>';
                        $content[] = '</div>';
                    $content[] = '</div>';
                $content[] = '</div>';
                ...
                $content[] = '<div style="position: absolute;right: 0;bottom: 1px;"  class="ays-quiz-dismiss-buttons-container-for-form-black-friday">';
                    $content[] = '<form action="" method="POST">';
                        $content[] = '<div id="ays-quiz-dismiss-buttons-content-black-friday">';
                            $content[] = '<button class="btn btn-link ays-button-black-friday" name="ays_quiz_sale_btn" style="">' . __( 'Dismiss ad', AYS_QUIZ_NAME ) . '</button>';
                        $content[] = '</div>';
                    $content[] = '</form>';
                $content[] = '</div>';
            $content[] = '</div>';
    ...
    */
    ...
    public function ays_quiz_update_banner_time(){
        ...
        $ays_quiz_banner_time = get_option('ays_quiz_banner_time');

        if ( !$ays_quiz_banner_time || is_null( $ays_quiz_banner_time ) ) {
            update_option('ays_quiz_banner_time', $next_3_days ); 
        }

        $get_ays_quiz_banner_time = get_option('ays_quiz_banner_time');
