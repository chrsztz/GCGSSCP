...
*/
define('WP_COPY_RIGHTS_VERSION', 5.3);
...
function wp_copy_rights_setting_page() {
    ...
    <div class="laobuluo-wbs-header" style="margin-bottom: 15px;">
              <div class="laobuluo-wbs-logo"><a><img src="<?php echo plugin_dir_url( __FILE__ );?>layui/images/logo.png"></a><span class="wbs-span">WPCopyRights 网站防复制插件</span><span class="wbs-free">Free V5.2</span></div>
